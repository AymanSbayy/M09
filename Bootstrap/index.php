        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                <a style="color: white" class="nav-link" href="vistes/login.php">Iniciar sesión</a>
              </li>
              <li class="nav-item">
                <a style="color: white" class="nav-link" href="vistes/register.php">Registrarse</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <div class="container my-4 divv">
    ...
    <div style="align-items: column; padding-left:47px; ">
      <div style="display:flex; flex-direction: row; justify-content: space-between;">
        ...
        <div>
          <a class="link" href="#" title="Editar article">
